...
function Footer() {
    ...
    <li>
                ...
                <div className="mx-auto w-full lg:max-w-[83%] lg:flex lg:items-center lg:justify-between lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] py-3">
                    <span className="sm:text-center ms-5 lg:ms-0">© {year} <Link href="/" className="hover:text-white">1Anime X AniPlay</Link> | Made by <span className="font-bold" >1Anime Team</span>
                    </span>
                    <div className="flex mt-4 lg:justify-center lg:mt-0">
    <Link href="https://https://discord.gg/pWgPSJ2U83/1Anime" target="_blank" className="hover:text-gray-900 dark:hover:text-white ms-5">

...
function SettingsPage() {
        ...
        <div>
            <div className='relative h-[240px] md:h-[340px]'>
                ...
                <div className='absolute left-[2%] lg:left-[7%] xl:left-[9.5%] bottom-6 lg:bottom-10  z-[6] text-[35px] text-bold flex flex-row items-center'>
                    ...
                    Settings</div>
            </div>  <div className='flex flex-col w-[100%]'>
                            <p className='text-[18px] md:text-[21px] font-medium mb-2'><svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <>
                      ...
                      <div className='mx-3 bg-[#1a1a1f] text-xs font-bold px-5 py-3 rounded-lg flex items-center w-[100%] justify-between'>
                        ...
                        <div className='flex flex-col w-[100%]'>
                            <p className='text-[15px] md:text-[21px] font-medium mb-2'><svg className="w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
 ...
 Load Strategies</p>
                        ...
                        <div className='flex flex-col w-[100%]'>
                            <p className='text-[18px] md:text-[21px] font-medium mb-2'><svg className="w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
 ...
 Privacy & Account</p>
                        ...
                        <div className='flex flex-col w-[100%]'>
                            <p className='text-[18px] md:text-[21px] font-medium mb-2'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">

    ...
    return (
        <div>
            <div className='relative h-[240px] md:h-[340px]'>
                ...
                <div className='mx-3 bg-[#1a1a1f] text-xs font-bold px-5 py-3 rounded-lg absolute left-[2%] lg:left-[7%] xl:left-[9.5%] bottom-6 lg:bottom-10  z-[6] text-[35px] text-bold flex flex-row items-center'>

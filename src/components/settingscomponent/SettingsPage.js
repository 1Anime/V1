        ...
        <div>
            ...
            <div className='max-w-[94%] md:max-w-[95%] lg:max-w-[85%] xl:max-w-[80%] mx-auto min-h-[58vh] flex flex-col gap-6 mt-5'>
                {loading ? (
                    ...
                    <>
                    <div className='mx-3 bg-[#1a1a1f] px-5 py-3 rounded-lg absolute left-[2%] lg:left-[7%] xl:left-[9.5%] bottom-6 lg:bottom-10  z-[6] text-[35px] text-bold flex flex-row items-center'>

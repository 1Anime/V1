...
function FloatingButton({session}) {
    ...
    return (
        <Dropdown backdrop="blur" placement="bottom-end" classNames={{
            ...
            <DropdownTrigger>
                <button className="fixed bottom-5 center-4 w-[45px] h-[45px] text-white rounded-full flex items-center justify-center box-border outline-none bg-[#4d148c] shadow-2xl md:hidden">
